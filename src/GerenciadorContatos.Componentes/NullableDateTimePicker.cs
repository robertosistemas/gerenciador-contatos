...
namespace GerenciadorContatos.Componentes
{
    ...
    public class NullableDateTimePicker : System.Windows.Forms.DateTimePicker
    {
        ...
        /// </summary>
        private void SetFormatAsString(string value)
        {
        ...
        private void SetFormat()
        {
            ...
            switch (_format)
            {
                case DateTimePickerFormat.Long:
                    SetFormatAsString(dtf.LongDatePattern);
                    break;
                case DateTimePickerFormat.Short:
                    SetFormatAsString(dtf.ShortDatePattern);
                    break;
                case DateTimePickerFormat.Time:
                    SetFormatAsString(dtf.ShortTimePattern);
                    break;
                case DateTimePickerFormat.Custom:
                    SetFormatAsString(CustomFormat);
                    break;
            }
        }
